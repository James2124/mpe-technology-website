import{t as e}from"./starter-products-BTnoZ0fu.js";import{env as t}from"cloudflare:workers";function n(){let e=t.DB;if(!e)throw Error(`D1 binding DB is unavailable`);return e}function r(){let e=t.PRODUCT_IMAGES;if(!e)throw Error(`R2 binding PRODUCT_IMAGES is unavailable`);return e}var i=null;function a(){return i??=o(),i}async function o(){let t=n();await t.batch([t.prepare(`CREATE TABLE IF NOT EXISTS products (
